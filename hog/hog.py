...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    if not(score0 in [0,1] or score1 in [0,1]):
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if  diff > previous_high:
            ...
            high = diff
        return announce_highest(who,previous_high=high,previous_score=score)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for num_rolls in range(1,11):
        ...
        res = averaged_dice(num_rolls,dice)
        if res>best_res:
            best_res = res
            best = num_rolls
    return best
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    bacon_plus = free_bacon(opponent_score)
    if opponent_score % (score + bacon_plus) == 0 and opponent_score // (score + bacon_plus) >= 2 or bacon_plus >= margin:
        return 0
    else:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return swap_strategy(score,opponent_score,8.764,8)
    # END PROBLEM 12
